...
public interface StructureSetsMixin {
	/**
	 * @author Sensei
	 * @reason Cannot redirect in interface, I also hate Mojank
	 */
	@Overwrite
	static void bootstrap(Registerable<StructureSet> structureSetRegisterable) {
		...
		structureSetRegisterable.register(
			...
			new StructureSet(
				...
				// This is the one line that changed
				new ConcentricRingsStructurePlacement(10, 3, 128, registryEntryLookup2.getOrThrow(BiomeTags.STRONGHOLD_BIASED_TO))
			)
		);
	}
}
