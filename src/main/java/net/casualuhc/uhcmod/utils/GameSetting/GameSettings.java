...
public class GameSettings {
    ...
    public static GameSetting.DoubleGameSetting
        WORLD_BORDER_SPEED = new GameSetting.DoubleGameSetting("world_border_speed", "This will change the speed of the world border", Map.of("slow", 0.8D, "normal", 1.0D, "fast", 1.2D), 1.0D),
