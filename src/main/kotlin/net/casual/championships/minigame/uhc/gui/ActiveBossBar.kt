...
class ActiveBossBar(
    ...
    override fun getTitle(player: ServerPlayer): Component {
        val start = Component.empty()
            ...
            .append("%02d".format(this.owner.getPlayingPlayers().size).literal().monospaced())
        ...
        val end = Component.empty()
            ...
            .append(Texts.ICON_SHORT_BACKGROUND.shadowless())
            .append(Texts.space(-27))
            .append("%02d".format(this.owner.stats.getOrCreateStat(player, ArcadeStats.KILLS).value).literal().monospaced())
